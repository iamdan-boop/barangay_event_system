...
<div class="wrapper">
    ...
    <div class="wrapper">
        ...
        <div style="margin-left: 57%; margin-top: 20%;">
            <label>
                {{ $certificate_payment->created_at }}
            </label>
        </div>
        ...
        <div style="display: flex; margin-left: 44%; margin-top: 2%;">
            ...
            <label style="margin-right: 3%;">
                {{ $certificate_payment->agency }}
            </label>

            <label style="margin-left: 16%;">
                {{ $certificate_payment->fund }}
            </label>
        ...
        <div style="margin-left: 43%; margin-top: 8px;">
            <label>
                {{ $certificate_payment->citizen->first_name. ' '. $certificate_payment->citizen->last_name  }}
            </label>
        </div>

        <div style="display: flex; margin-top: 7%; margin-left: 37%;">
            <label>
                {{ $certificate_payment->nature_of_collection }}
            </label>

            <label>
                {{ $certificate_payment->account_code }}
            </label>

            <label style="margin-left: 1%; ">
                {{ $certificate_payment->amount }}
            </label>
        </div>
...
{{--        </div>--}}
        ...
        <div style="margin-top: 10px; margin-left: 47%; font-size: 10px; display: flex;">
            <label>
                {{ $certificate_payment->drawee_bank }}
            </label>

            <label>
                {{ $certificate_payment->drawee_bank_number }}
            </label>
