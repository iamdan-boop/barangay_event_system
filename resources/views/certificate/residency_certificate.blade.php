    ...
    <div class="wrapper">
        <div class="content-wrapper">
            ...
            <table class="content" width="90%" style="margin-top: 20px;">
                <tr>
                    <td style="padding-left: 50px; letter-spacing: 2px;">
                        <p><b><i> TO WHOM IT MAY CONCERN: </i></b></p>
                    </td>
                </tr>
                <tr>
                    <td style="padding-left: 50px">
                        <p style="text-align: justify; letter-spacing: 2px; line-height: 25px;">
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; This is to certify that <u>{{$citizen['last_name']}} {{$citizen['first_name']}} {{$citizen['middle_name']}}</u>,
                        of legal age, {{$citizen['status']}} and resident of {{$citizen['address']}}, Pacol, Naga City 
                        for six (6) years and has <B>NO DEROGATORY RECORD/S</B> in this office.
                        </p>
            ...
            <table width="100%">
                <tr>
                    <td>
                        <p style="text-align:  center; margin-top: 0; margin-left: 0px; margin-top: 250px;">Control #<b style="color: red;">{{$control_number}}</b></p>
                    </td>
                </tr>   
            </table>
        </center>
