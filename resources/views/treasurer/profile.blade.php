        ...
        <div id="content">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item" href="{{route('t_profile')}}">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-6 offset-lg-3">
                    <form class="user" action="{{route('t_profile_check')}}" method="POST">
                        @csrf
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                       placeholder="First Name" name="first_name" value="{{Auth::user()->first_name}}"
                                       required>
                            </div>
                            <div class="col-sm-6">
                                <input type="text" class="form-control form-control-user" id="exampleLastName"
                                       placeholder="Last Name" name="last_name" value="{{Auth::user()->last_name}}"
                                       required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" id="exampleInputEmail"
                                   placeholder="Address" name="address" value="{{Auth::user()->address}}" required>
                        </div>

                        <div class="form-group">
                            <input type="email" class="form-control form-control-user" id="exampleInputEmail"
                                   placeholder="Email Address" name="email" value="{{Auth::user()->email}}" required>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" id="exampleInputEmail"
                                   placeholder="Contact Number" name="contact" value="{{Auth::user()->contact}}"
                                   required>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control form-control-user" id="calendar"
                                   placeholder="Date of Birth" name="dob" required value="{{Auth::user()->dob}}">
                        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="{{route('t_logout')}}">Logout</a>
            </div>
        </div>
    </div>
</div>
